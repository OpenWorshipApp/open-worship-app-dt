...
description: 'Research and improve the Open Worship App in-app help assistant: answer quality, prompts, knowledge, walkthroughs, UI, reliability and tool use. Use for chatbot or assistant improvement requests. Baseline real questions, verify changes live, and track measured progress. Server implementation and firewall work belongs to owa-enhance-mcp.'
---

## Codex usage

Invoke as `$owa-enhance-chatbot` followed by the request or options.
