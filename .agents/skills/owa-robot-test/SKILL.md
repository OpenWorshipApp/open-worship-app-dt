---
name: owa-robot-test
description: Run live QA, smoke tests, full-coverage UI testing or focused robot testing of Open Worship App through owa-devtools MCP. Also use to create or verify tutorials and user documentation against observed behavior. Supports packaged-app and presenting-flow modes, resumable coverage, and mandatory screen, locale and media checks.
---

## Codex usage

Invoke as `$owa-robot-test` followed by the request or options.
