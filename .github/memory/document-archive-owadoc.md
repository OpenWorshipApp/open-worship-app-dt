...
description: A single document (.owadoc) or bible list (.owbible) exports/imports through one shared single-item bundle; the archive machinery lives in helper/
metadata:
  type: project
---
...
Docs: matrix rows PL-77..PL-80 + PR-27..PR-29 + CM-36..CM-39, workflows W-23 / W-24.
