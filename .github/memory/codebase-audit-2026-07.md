...
Related: [[screen-draw-feature]]. (Event-dispatch semantics now live in
CLAUDE.md's "Event dispatch is microtask-async" section; the old
`eventhandler-sync-dispatch` memory was retired 2026-08-30.)
