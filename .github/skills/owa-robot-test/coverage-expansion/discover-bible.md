...
| RD-03 | `InputHandlerComp` | ⌨️✎ | — | reader | type `John 3:16` char-by-char | book-filters only; `3:16` dropped on book pick (same as modal — shared component). Verified 2026-08-05 | InputHandlerComp.tsx:135 | COVERED |
