...
- [Lookup has its own language](lookup-language-selection.md) — one dataset loaded at a time; the in-text index stays English while only the labels sidecar is per-language
