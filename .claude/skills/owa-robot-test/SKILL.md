...
[docs/test-paths/coverage-matrix.md](../../../docs/test-paths/coverage-matrix.md) (~634 rows with stable
...
- [docs/test-paths/coverage-matrix.md](../../../docs/test-paths/coverage-matrix.md) — the
  **coverage contract**: ~634 stable-ID rows over the whole UI surface — every interactive
