...
/**
 * Clicking a document in a presenting flow does what clicking it in the Documents list
 ...
 * actually expanded — a collapsed presenting flow never touches the file.
 */
