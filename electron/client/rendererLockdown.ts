...
// One entry per window that should not have Node. Only the chatbot is on it:
// it is the only renderer whose content comes from outside the machine. Adding
...
const LOCKED_DOWN_PATH_NAMES = ['/chatbot.html'];
